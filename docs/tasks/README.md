...
| [P3-03](P3-03-incremental-reembedding.md) | Re-embedding incremental (cache v4 + progreso) | `feat/incremental-reembedding` | M | [12](../features/12-incremental-reembedding.md) | ✅ Merged (#151) |
