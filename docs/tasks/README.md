...
|----|-------|------|:------:|------|--------|
| [P1-01](P1-01-bridge-latent-tools.md) | Exponer 8 comandos latentes del bridge como tools | `feat/bridge-latent-tools` | S | [01](../features/01-bridge-latent-tools.md) | Pendiente |
...
| ID | Tarea | Rama | Tamaño | Spec | Estado |
|----|-------|------|:------:|------|--------|
| [P2-01](P2-01-local-generation.md) | Generación local con Ollama (`KIOKU_GEN_MODEL`) — **enabler** | `feat/local-generation` | M | [05](../features/05-local-generation.md) | Pendiente |
...
| [P2-03](P2-03-daily-digest.md) | Daily digest (`generate_digest`) | `feat/daily-digest` | S | [07](../features/07-daily-digest.md) | Pendiente |
...
| ID | Tarea | Rama | Tamaño | Spec | Estado |
|----|-------|------|:------:|------|--------|
| [P3-01](P3-01-zotero-bibtex.md) | Import/export BibTeX (base para Zotero) | `feat/zotero-bibtex` | M | [10](../features/10-zotero-bibtex.md) | Pendiente |
...
| [P3-04](P3-04-citation-graph.md) | Grafo de citas entre notas y fuentes | `feat/citation-graph` | M | — | Pendiente |
