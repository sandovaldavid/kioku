...
Current server package version: **3.0.0**. <!-- x-release-please-version --> The NuGet PackageVersion is authoritative for the server and must match both version fields in the MCP server manifest.
