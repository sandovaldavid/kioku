...
Kioku es un servidor MCP (Model Context Protocol) que permite a agentes de IA como **Claude Code** y **Antigravity CLI** leer, buscar, escribir y organizar tu bóveda de Obsidian de manera nativa, rápida y privada — con 113 herramientas MCP en 18 clases y 22 comandos del bridge del plugin.
...
Kioku.Mcp.Server (C# .NET 10)
    ├── 18 Tool Classes (113 herramientas MCP)
...
113 herramientas organizadas en 18 clases. Para el inventario completo con parámetros, ver [`docs/commands-reference.md`](docs/commands-reference.md).
